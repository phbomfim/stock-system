            ...
            if @produto.valid? && @local.valid?
                ...
                if tipo_de_movimentacao == " E"
                    ...
                    if @movimentacao.save
                        ...
                        if @movimentacao.valid? == false
                            puts "#{@movimentacao.errors.messages}"
                            File.write("log.txt","Movimentacao erro: #{@movimentacao.errors.messages}", mode: "a")
                            File.write("log.txt", "\n", mode: "a")
                        end
                    end
                ...
                ## Segundo caso = SAIDA
                    ...
                    if @estoque.present?
                        ...
                        File.write("log.txt","Estoque não encontrado!", mode: "a")
                        File.write("log.txt", "\n", mode: "a")
                    end
